...
#define VFUNC_1ARG(func, arg1, ...) \
    _VFUNC1(func, arg1, __NARG__(__VA_ARGS__))(arg1, __VA_ARGS__)

#define _VFUNC2(name, arg1, arg2, n) _VFUNC_(name, n)
#define VFUNC_2ARG(func, arg1, arg2, ...) \
    _VFUNC2(func, arg1, arg2, __NARG__(__VA_ARGS__))(arg1, arg2, __VA_ARGS__)

#define _VFUNC3(name, arg1, arg2, arg3, n) _VFUNC_(name, n)
#define VFUNC_3ARG(func, arg1, arg2, arg3, ...)            \
    _VFUNC3(func, arg1, arg2, arg3, __NARG__(__VA_ARGS__)) \
    (arg1, arg2, arg3, __VA_ARGS__)
