...
static void _EasyUI_showStr(uint16_t x, uint16_t y, char *str, uint16_t color) {
  if (!_easyui_xor) u8g2_SetDrawColor(_easyui_u8g2, color);
...
static void _EasyUI_clearBuffer(void) { u8g2_ClearBuffer(_easyui_u8g2); }

static void _EasyUI_sendBuffer(void) { u8g2_SendBuffer(_easyui_u8g2); }
