...
void EasyUIDemoInit(void) {
  ...
  EasyUIAddItem(NULL, pageMain, ITEM_JUMP_PAGE, "Test Single Sel", pageSingle);
  ...
  EasyUIAddItem(NULL, pageMain, ITEM_MESSAGE, "Reset settings", "Resetting...",
  ...
  EasyUIAddItem(NULL, pageMulti, ITEM_PAGE_DESCRIPTION, "[Multiple selection]");
  ...
  EasyUIAddItem(NULL, pageSingle, ITEM_PAGE_DESCRIPTION, "[Single selection]");
  ...
  EasyUIAddItem(NULL, pageSwitch, ITEM_SWITCH, "Switch 1", &sw1, state_change);
  EasyUIAddItem(NULL, pageSwitch, ITEM_SWITCH, "Switch 2", &sw2, state_change);
  EasyUIAddItem(NULL, pageSwitch, ITEM_SWITCH, "Switch 3", &sw3, state_change);
  ...
  EasyUIAddItem(NULL, pageEditor, ITEM_VALUE_EDITOR, "Test int", &testInt, 1E9,
                -1E9, 0, value_change, 0);
