...
#define UMM_MULTI_FRAGMENTATION_METRIC_INIT(h) \
  umm_multi_fragmentation_metric_init(h)
#define UMM_MULTI_FRAGMENTATION_METRIC_ADD(h, c) \
  umm_multi_fragmentation_metric_add(h, c)
#define UMM_MULTI_FRAGMENTATION_METRIC_REMOVE(h, c) \
  umm_multi_fragmentation_metric_remove(h, c)
...
extern void *umm_multi_info(struct umm_heap_config *heap, void *ptr,
                            bool force);
...
extern void *umm_multi_poison_calloc(struct umm_heap_config *heap, size_t num,
                                     size_t size);
extern void *umm_multi_poison_realloc(struct umm_heap_config *heap, void *ptr,
                                      size_t size);
