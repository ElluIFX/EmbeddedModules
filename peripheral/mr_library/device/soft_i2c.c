...
MR_INLINE void soft_i2c_scl_set(struct mr_soft_i2c_bus* soft_i2c_bus,
                                uint8_t value) {
    _mr_fast_pin_write(soft_i2c_bus->scl_pin, value);
}

MR_INLINE void soft_i2c_bus_sda_set(struct mr_soft_i2c_bus* soft_i2c_bus,
                                    uint8_t value) {
...
static int mr_soft_i2c_bus_configure(struct mr_i2c_bus* i2c_bus,
                                     struct mr_i2c_config* config, int addr,
                                     int addr_bits) {
    struct mr_soft_i2c_bus* soft_i2c_bus = (struct mr_soft_i2c_bus*)i2c_bus;
...
static int mr_soft_i2c_bus_send_addr(struct mr_i2c_bus* i2c_bus, int addr,
                                     int addr_bits) {
...
static int mr_soft_i2c_bus_read(struct mr_i2c_bus* i2c_bus, uint8_t* data,
                                int ack_state) {
    struct mr_soft_i2c_bus* soft_i2c_bus = (struct mr_soft_i2c_bus*)i2c_bus;
...
static int mr_soft_i2c_bus_write(struct mr_i2c_bus* i2c_bus, uint8_t data) {
    ...
    for (size_t bits = 0; bits < 8; bits++) {
        soft_i2c_bus_sda_set(soft_i2c_bus,
                             (data & 0x80) ? SOFT_I2C_HIGH : SOFT_I2C_LOW);
        data <<= 1;
...
int mr_soft_i2c_bus_register(struct mr_soft_i2c_bus* soft_i2c_bus,
                             const char* path, int scl_pin, int sda_pin) {
    static struct mr_i2c_bus_ops ops = {
        mr_soft_i2c_bus_configure, mr_soft_i2c_bus_start,
        mr_soft_i2c_bus_send_addr, mr_soft_i2c_bus_stop,
        mr_soft_i2c_bus_read,      mr_soft_i2c_bus_write};
