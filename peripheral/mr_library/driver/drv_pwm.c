...
#if !defined(MR_USING_PWM1) && !defined(MR_USING_PWM2) &&   \
    !defined(MR_USING_PWM3) && !defined(MR_USING_PWM4) &&   \
    !defined(MR_USING_PWM5) && !defined(MR_USING_PWM8) &&   \
    !defined(MR_USING_PWM9) && !defined(MR_USING_PWM10) &&  \
    !defined(MR_USING_PWM11) && !defined(MR_USING_PWM12) && \
    !defined(MR_USING_PWM13) && !defined(MR_USING_PWM14)
...
static int drv_pwm_channel_configure(struct mr_pwm* pwm, int channel, int state,
                                     int polarity) {
    struct drv_pwm_data* pwm_data = (struct drv_pwm_data*)pwm->dev.drv->data;
    uint32_t ChannelState =
        (state == ENABLE) ? TIM_CCx_ENABLE : TIM_CCx_DISABLE;
    ...
    sConfigOC.OCPolarity = (polarity == MR_PWM_POLARITY_NORMAL)
                               ? TIM_OCPOLARITY_HIGH
                               : TIM_OCPOLARITY_LOW;
    sConfigOC.OCNPolarity = (polarity == MR_PWM_POLARITY_NORMAL)
...
static void drv_pwm_start(struct mr_pwm* pwm, uint32_t prescaler,
                          uint32_t period) {
    struct drv_pwm_data* pwm_data = (struct drv_pwm_data*)pwm->dev.drv->data;
...
static int drv_pwm_read(struct mr_pwm* pwm, int channel,
...
static int drv_pwm_write(struct mr_pwm* pwm, int channel,
                         uint32_t compare_value) {
    struct drv_pwm_data* pwm_data = (struct drv_pwm_data*)pwm->dev.drv->data;
    uint32_t Channel = (channel - 1) << 2;
...
static struct mr_pwm_ops pwm_drv_ops = {
    drv_pwm_configure, drv_pwm_channel_configure, drv_pwm_start, drv_pwm_read,
    drv_pwm_write};

static struct mr_drv pwm_drv[] = {
#ifdef MR_USING_PWM1
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM1]},
#endif /* MR_USING_PWM1 */
#ifdef MR_USING_PWM2
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM2]},
#endif /* MR_USING_PWM2 */
#ifdef MR_USING_PWM3
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM3]},
#endif /* MR_USING_PWM3 */
#ifdef MR_USING_PWM4
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM4]},
#endif /* MR_USING_PWM4 */
#ifdef MR_USING_PWM5
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM5]},
#endif /* MR_USING_PWM5 */
#ifdef MR_USING_PWM6
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM6]},
#endif /* MR_USING_PWM6 */
#ifdef MR_USING_PWM7
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM7]},
#endif /* MR_USING_PWM7 */
#ifdef MR_USING_PWM8
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM8]},
#endif /* MR_USING_PWM8 */
#ifdef MR_USING_PWM9
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM9]},
#endif /* MR_USING_PWM9 */
#ifdef MR_USING_PWM10
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM10]},
#endif /* MR_USING_PWM10 */
#ifdef MR_USING_PWM11
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM11]},
#endif /* MR_USING_PWM11 */
#ifdef MR_USING_PWM12
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM12]},
#endif /* MR_USING_PWM12 */
#ifdef MR_USING_PWM13
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM13]},
#endif /* MR_USING_PWM13 */
#ifdef MR_USING_PWM14
    {&pwm_drv_ops, &pwm_drv_data[DRV_INDEX_PWM14]},
#endif /* MR_USING_PWM14 */
};
