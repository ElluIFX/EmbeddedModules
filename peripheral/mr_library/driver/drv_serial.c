...
#if !defined(MR_USING_UART1) && !defined(MR_USING_UART2) && \
    !defined(MR_USING_UART3) && !defined(MR_USING_UART4) && \
    !defined(MR_USING_UART5) && !defined(MR_USING_UART6) && \
    !defined(MR_USING_UART7) && !defined(MR_USING_UART8)
...
static int drv_serial_configure(struct mr_serial* serial,
                                struct mr_serial_config* config) {
    struct drv_serial_data* serial_data =
        (struct drv_serial_data*)serial->dev.drv->data;
...
#if defined(STM32L4) || defined(STM32WL) || defined(STM32F7) ||  \
    defined(STM32F0) || defined(STM32L0) || defined(STM32G0) ||  \
    defined(STM32H7) || defined(STM32L5) || defined(STM32G4) ||  \
    defined(STM32MP1) || defined(STM32WB) || defined(STM32F3) || \
...
static void drv_serial_isr(struct mr_serial* serial) {
    ...
    if ((__HAL_UART_GET_FLAG(&serial_data->handle, UART_FLAG_RXNE) != RESET) &&
        (__HAL_UART_GET_IT_SOURCE(&serial_data->handle, UART_IT_RXNE) !=
         RESET)) {
...
static struct mr_serial_ops serial_drv_ops = {
    drv_serial_configure, drv_serial_read, drv_serial_write,
    drv_serial_start_tx, drv_serial_stop_tx};

static struct mr_drv serial_drv[] = {
#ifdef MR_USING_UART1
    {&serial_drv_ops, &serial_drv_data[DRV_INDEX_UART1]},
#endif /* MR_USING_UART1 */
#ifdef MR_USING_UART2
    {&serial_drv_ops, &serial_drv_data[DRV_INDEX_UART2]},
#endif /* MR_USING_UART2 */
#ifdef MR_USING_UART3
    {&serial_drv_ops, &serial_drv_data[DRV_INDEX_UART3]},
#endif /* MR_USING_UART3 */
#ifdef MR_USING_UART4
    {&serial_drv_ops, &serial_drv_data[DRV_INDEX_UART4]},
#endif /* MR_USING_UART4 */
#ifdef MR_USING_UART5
    {&serial_drv_ops, &serial_drv_data[DRV_INDEX_UART5]},
#endif /* MR_USING_UART5 */
#ifdef MR_USING_UART6
    {&serial_drv_ops, &serial_drv_data[DRV_INDEX_UART6]},
#endif /* MR_USING_UART6 */
#ifdef MR_USING_UART7
    {&serial_drv_ops, &serial_drv_data[DRV_INDEX_UART7]},
#endif /* MR_USING_UART7 */
#ifdef MR_USING_UART8
    {&serial_drv_ops, &serial_drv_data[DRV_INDEX_UART8]},
#endif /* MR_USING_UART8 */
};
