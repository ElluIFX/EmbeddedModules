...
#include "drv_timer.h"
    ...
    !defined(MR_USING_TIMER3) && !defined(MR_USING_TIMER4) &&   \
    !defined(MR_USING_TIMER5) && !defined(MR_USING_TIMER8) &&   \
    !defined(MR_USING_TIMER9) && !defined(MR_USING_TIMER10) &&  \
    !defined(MR_USING_TIMER11) && !defined(MR_USING_TIMER12) && \
    !defined(MR_USING_TIMER13) && !defined(MR_USING_TIMER14)
...
static int drv_timer_configure(struct mr_timer* timer, int state) {
    struct drv_timer_data* timer_data =
        (struct drv_timer_data*)timer->dev.drv->data;
    ...
    if (state == ENABLE) {
        ...
        timer_data->handle.Init.AutoReloadPreload =
...
static void drv_timer_start(struct mr_timer* timer, uint32_t prescaler,
                            uint32_t period) {
    struct drv_timer_data* timer_data =
        (struct drv_timer_data*)timer->dev.drv->data;
...
static void drv_timer_isr(struct mr_timer* timer) {
    ...
    if ((__HAL_TIM_GET_FLAG(&timer_data->handle, TIM_FLAG_UPDATE) != RESET) &&
        (__HAL_TIM_GET_IT_SOURCE(&timer_data->handle, TIM_IT_UPDATE) !=
         RESET)) {
...
static struct mr_timer_ops timer_drv_ops = {
    drv_timer_configure, drv_timer_start, drv_timer_stop, drv_timer_get_count};

static struct mr_drv timer_drv[] = {
#ifdef MR_USING_TIMER1
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER1]},
#endif /* MR_USING_TIMER1 */
#ifdef MR_USING_TIMER2
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER2]},
#endif /* MR_USING_TIMER2 */
#ifdef MR_USING_TIMER3
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER3]},
#endif /* MR_USING_TIMER3 */
#ifdef MR_USING_TIMER4
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER4]},
#endif /* MR_USING_TIMER4 */
#ifdef MR_USING_TIMER5
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER5]},
#endif /* MR_USING_TIMER5 */
#ifdef MR_USING_TIMER6
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER6]},
#endif /* MR_USING_TIMER6 */
#ifdef MR_USING_TIMER7
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER7]},
#endif /* MR_USING_TIMER7 */
#ifdef MR_USING_TIMER8
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER8]},
#endif /* MR_USING_TIMER8 */
#ifdef MR_USING_TIMER9
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER9]},
#endif /* MR_USING_TIMER9 */
#ifdef MR_USING_TIMER10
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER10]},
#endif /* MR_USING_TIMER10 */
#ifdef MR_USING_TIMER11
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER11]},
#endif /* MR_USING_TIMER11 */
#ifdef MR_USING_TIMER12
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER12]},
#endif /* MR_USING_TIMER12 */
#ifdef MR_USING_TIMER13
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER13]},
#endif /* MR_USING_TIMER13 */
#ifdef MR_USING_TIMER14
    {&timer_drv_ops, &timer_drv_data[DRV_INDEX_TIMER14]},
#endif /* MR_USING_TIMER14 */
};

static void drv_timer_init(void) {
    for (size_t i = 0; i < MR_ARRAY_NUM(timer_dev); i++) {
        mr_timer_register(&timer_dev[i], timer_path[i], &timer_drv[i],
                          &timer_info[i]);
    }
}
