...
static inline void cdc_start_transfers(void) { start_next_cdc_transfer(0); }
...
static inline uint8_t cdc_connected(void) { return cdc_acm_connected(); }

static inline uint8_t cdc_idle(void) { return cdc_acm_idle(); }
#else
