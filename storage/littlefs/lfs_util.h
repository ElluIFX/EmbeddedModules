...
#ifndef LFS_TRACE
#ifdef LFS_YES_TRACE
#define LFS_TRACE(...) LOG_TRACE(__VA_ARGS__)
#else
#define LFS_TRACE(...)
#endif
#endif
...
#ifndef LFS_DEBUG
#ifndef LFS_NO_DEBUG
#define LFS_DEBUG(...) LOG_DEBUG(__VA_ARGS__)
#else
#define LFS_DEBUG(...)
#endif
#endif
...
#ifndef LFS_WARN
#ifndef LFS_NO_WARN
#define LFS_WARN(...) LOG_WARN(__VA_ARGS__)
#else
#define LFS_WARN(...)
#endif
#endif
...
#ifndef LFS_ERROR
#ifndef LFS_NO_ERROR
#define LFS_ERROR(...) LOG_ERROR(__VA_ARGS__)
#else
#define LFS_ERROR(...)
#endif
#endif
...
#define LFS_ASSERT(test) LOG_ASSERT(test)
#else
