...
- [s\_task - full platform multi-task library for C](#s_task---full-platform-multi-task-library-for-c)
  ...
  - [Specials on embedded platform](#specials-on-embedded-platform)
    - [Chan for interrupt (for embedded only, STM8/STM32/M051/Arduino)](#chan-for-interrupt-for-embedded-only-stm8stm32m051arduino)
      - [chan api called in tasks](#chan-api-called-in-tasks)
      - [chan api called in interrupt](#chan-api-called-in-interrupt)
    - [Event for interrupt (for embedded only, STM8/STM32/M051/Arduino)](#event-for-interrupt-for-embedded-only-stm8stm32m051arduino)
      - [event api called in tasks](#event-api-called-in-tasks)
      - [event api called in interrupt](#event-api-called-in-interrupt)
